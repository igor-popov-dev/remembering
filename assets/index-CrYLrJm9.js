...
function clientMiddlewareErrorHandler(error, routeId, matches, didCallHandler) {
  ...
  if (didCallHandler) {
    ...
    let boundaryRouteId = findNearestBoundary(
      matches,
      ((_a2 = matches.find((m) => m.route.id === routeId || m.route.loader)) == null ? void 0 : _a2.route.id) || routeId
    ).route.id;
    return {
...
const button$1 = "_button_jzysf_1";
const styles$8 = {
  button: button$1
};
const ActionBtn = ({ type, onClick, disabled }) => {
  if (type === "play") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: styles$8.button, onClick, disabled, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "play.svg", alt: "Logo", width: 20 }),
      "Прослушать"
    ] });
  }
  if (type === "done") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: styles$8.button, onClick, disabled, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "done.svg", alt: "Logo", width: 20 }),
      "Готово"
    ] });
  }
};
const header = "_header_sx5kj_19";
const burger = "_burger_sx5kj_73";
const menu = "_menu_sx5kj_107";
const active$1 = "_active_sx5kj_135";
const headerLine = "_headerLine_sx5kj_221";
const styles$7 = {
  header,
  "header-title": "_header-title_sx5kj_51",
  burger,
  menu,
  active: active$1,
  headerLine
...
const Header = ({ children, title }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: styles$7.header, ref: menuRef, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.headerLine, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7["header-title"], onClick: toggleMenu, children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: cn(styles$7.burger, { [styles$7.active]: menuActive }),
          onClick: toggleMenu,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn(styles$7.menu, { [styles$7.active]: menuActive }), children })
  ] });
};
const feelingsItems = [
  ...
  { name: "Тон", description: "тембр того звука, который присутствовал во время события.", question: "Какой тон ты получил во время воспоминания" },
  { name: "Внешнее движение", description: "движение других людей, объектов или энергий.", question: "Какое внешнее движение ты получил во время воспоминания" },
  { name: "Эмоция", description: "ту эмоцию, которую ты чувствовал во время этого случая.", question: "Какую эмоцию ты получил во время воспоминания" },
  { name: "Громкость", description: "громкость различных звуков в инциденте.", question: "Какую громкость ты получил во время воспоминания" },
  { name: "Положение тела", description: "положение твоего собственного тела в то время, когда произошел этот случай.", question: "Какое положение тела ты получил во время воспоминания" },
  { name: "Звук", description: "те звуки, которые присутствовали в инциденте.", question: "Какой звук ты получил во время воспоминания" },
  { name: "Вес", description: "тяжесть вещей, включая силу притяжения, и вес всего того, что ты мог действительно поддерживать во время случая, например, твоей одежды, мяча или любых других вещей, которые ты действительно держал во время случая.", question: "Какой вес ты получил во время воспоминания" },
  { name: "Свое движение", description: "движение, которое во время события предпринимал ты сам.", question: "Какое свое движение ты получил во время воспоминания" }
];
const wrapper$4 = "_wrapper_126ft_101";
const h1$4 = "_h1_126ft_161";
const h2$1 = "_h2_126ft_225";
const text$1 = "_text_126ft_295";
const input$1 = "_input_126ft_321";
const theme$1 = "_theme_126ft_479";
const select$1 = "_select_126ft_489";
const defenition$1 = "_defenition_126ft_613";
const shuffleButton$1 = "_shuffleButton_126ft_745";
const donat$1 = "_donat_126ft_869";
const btnWrapper = "_btnWrapper_126ft_923";
const step = "_step_126ft_945";
const show = "_show_126ft_955";
const footer = "_footer_126ft_967";
const autoplay = "_autoplay_126ft_995";
const styles$6 = {
  wrapper: wrapper$4,
  h1: h1$4,
  h2: h2$1,
...
const button = "_button_jtkzd_1";
const small = "_small_jtkzd_61";
const big = "_big_jtkzd_71";
const styles$5 = {
  button,
  small,
  big
...
const defaultQuestions = [
  "Вспомни случай, когда:",
  "Вспомни другой случай, когда:",
...
const lists = [
  ...
  },
  {
    ...
    questions: [
      "Вспомни случай, который произошёл:",
      "Вспомни другой случай, который произошёл:",
  ...
  },
  {
    ...
    questions: [
      "Вспомни случаи, по которым можно сравнить:",
      "Вспомни другие случаи, по которым можно сравнить:",
  ...
  },
  {
    ...
    questions: [
      "Вспомни зрительную картину, которая была:",
      "Вспомни другую зрительную картину, которая была:",
  ...
  },
  {
    ...
    questions: [
      "Вспомни случай, когда ты слышал:",
      "Вспомни другой случай, когда ты слышал:",
  ...
  },
  {
    ...
    questions: [
      "Вспомни случай, когда ты ощущал запах:",
      "Вспомни другой случай, когда ты ощущал запах:",
  ...
  },
  {
    ...
    questions: [
      "Вспомни случай, когда ты ощущал вкус:",
      "Вспомни другой случай, когда ты ощущал вкус:",
  ...
  },
  {
    ...
    questions: [
      "Вспомни случай, когда ты чувствовал (прикасаясь):",
      "Вспомни другой случай, когда ты чувствовал (прикасаясь):",
...
const initialState = {
  phrases: ((_a = loadState().phrases) == null ? void 0 : _a.length) && loadState().phrases || lists[0].phrases,
  currentQuestions: ((_b = loadState().currentQuestions) == null ? void 0 : _b.length) && loadState().currentQuestions || lists[0].questions,
...
const appSlice = createSlice({
  ...
  reducers: {
    ...
    setCurrentListId: (state, action) => {
      ...
      state.phrases = (currentList == null ? void 0 : currentList.phrases) || [];
      state.currentQuestions = (currentList == null ? void 0 : currentList.questions) || [];
      state.phraseIndex = 0;
...
const Audio = () => {
  var _a2, _b2;
  const [step2, setStep] = reactExports.useState(1);
  const [q1, setQ1] = reactExports.useState("");
  const [q3, setQ3] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: `Cписок: ${((_a2 = lists.find((item) => item.id === currentListId)) == null ? void 0 : _a2.theme) ?? ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.theme, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.text, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.wrapper, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(styles$6.step, { [styles$6.show]: step2 === 2 }), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: styles$6.h1, children: q2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.btnWrapper, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { type: "play", onClick: () => speakText(q2) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { disabled: step2 !== 2, type: "done", onClick: () => nextStep(3) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(styles$6.step, { [styles$6.show]: step2 === 3 }), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: styles$6.h1, children: q3 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$6.defenition, children: ((_b2 = feelingsItems[feelingIndex]) == null ? void 0 : _b2.description) ?? "" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.btnWrapper, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { type: "play", onClick: () => speakText(q3) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { disabled: step2 !== 3, type: "done", onClick: () => nextStep(1) })
        ] })
      ] }),
...
const accordion = "_accordion_d648y_1";
const active = "_active_d648y_75";
const secret = "_secret_d648y_135";
const styles$4 = {
  accordion,
  "accordion-item": "_accordion-item_d648y_19",
  "accordion-header": "_accordion-header_d648y_27",
  active,
  "accordion-content": "_accordion-content_d648y_85",
  secret
};
const itemsDefault = [
  {
...
const Accordion = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.accordion, children: items.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4["accordion-item"], children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: cn(styles$4["accordion-header"], { [styles$4.active]: activeIndex === index }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: cn(styles$4["accordion-content"], { [styles$4.active]: activeIndex === index }),
          style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.secret, onClick: handleHiddenClick })
  ] });
};
const h1$3 = "_h1_1i53f_1";
const wrapper$3 = "_wrapper_1i53f_27";
const content$2 = "_content_1i53f_49";
const styles$3 = {
  h1: h1$3,
  wrapper: wrapper$3,
  content: content$2
...
const h1$2 = "_h1_1g58n_1";
const note$1 = "_note_1g58n_15";
const wrapper$2 = "_wrapper_1g58n_25";
const content$1 = "_content_1g58n_47";
const qrCode = "_qrCode_1g58n_73";
const styles$2 = {
  h1: h1$2,
  note: note$1,
  wrapper: wrapper$2,
...
const Donat = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.wrapper, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: styles$2.h1, children: "Дорогой пользователь," }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$2.note, children: "Если тебе полезен наш продукт и ты хочешь поучаствовать в его существовании и развитии, можешь поддержать нас донатом:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.qrCode, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", version: "1.1", width: "150px", height: "150px", viewBox: "0 0 500 500", children: [
...
const h1$1 = "_h1_1lfk4_1";
const ol = "_ol_1lfk4_7";
const note = "_note_1lfk4_15";
const wrapper$1 = "_wrapper_1lfk4_25";
const content = "_content_1lfk4_47";
const styles$1 = {
  h1: h1$1,
  ol,
  note,
...
const Final = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.wrapper, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: styles$1.h1, children: "Инструкция по завершению сессии" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: styles$1.ol, children: [
...
const fadeIn = "_fadeIn_17mae_85";
const fadeOut = "_fadeOut_17mae_93";
const wrapper = "_wrapper_17mae_101";
const thxWrapper = "_thxWrapper_17mae_101";
const displayFlex = "_displayFlex_17mae_151";
const h1 = "_h1_17mae_159";
const h2 = "_h2_17mae_223";
const h3 = "_h3_17mae_263";
const randomize = "_randomize_17mae_285";
const text = "_text_17mae_293";
const thxText = "_thxText_17mae_293";
const input = "_input_17mae_319";
const theme = "_theme_17mae_477";
const select = "_select_17mae_487";
const defenition = "_defenition_17mae_611";
const buttons = "_buttons_17mae_727";
const shuffleButton = "_shuffleButton_17mae_739";
const donat = "_donat_17mae_863";
const styles = {
  fadeIn,
  fadeOut,
  wrapper,
...
const router = createBrowserRouter([
  ...
  {
    path: "/remembering/",
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(Audio, {})
  },
  {
...
//# sourceMappingURL=index-CrYLrJm9.js.map
