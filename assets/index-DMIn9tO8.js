...
const button$1 = "_button_zvl9r_1";
const styles$8 = {
  button: button$1
};
...
const active$3 = "_active_11qnu_68";
...
const feelingsItems = [
  ...
  { name: "Запах", description: "запахи, которые присутствовали во время ситуации, которую ты вспоминаешь.", question: "Какой запах вы получили во время воспоминания" },
  { name: "Осязание", description: "все, что угодно, что ты действительно осязал в то время, включая давление.", question: "Какое осязание вы получили во время воспоминания" },
  { name: "Цвет", description: "действительный цвет, который содержался в требуемом случае.", question: "Какой цвет вы получили во время воспоминания" },
  { name: "Тон", description: "тембр того звука, который присутствовал во время события.", question: "Какой тон вы получили во время воспоминания" },
  { name: "Внешнее движение", description: "движение других людей, объектов или энергий.", question: "Какое внешнее движение вы получили во время воспоминания" },
  { name: "Эмоция", description: "ту эмоцию, которую ты чувствовал во время этого случая.", question: "Какую эмоцию вы получили во время воспоминания" },
  { name: "Громкость", description: "громкость различных звуков в инциденте.", question: "Какую громкость вы получили во время воспоминания" },
  { name: "Положение тела", description: "положение твоего собственного тела в то время, когда произошел этот случай.", question: "Какое положение тела вы получили во время воспоминания" },
  { name: "Звук", description: "те звуки, которые присутствовали в инциденте.", question: "Какой звук вы получили во время воспоминания" },
...
const styles$6 = {
  ...
  fadeOut: fadeOut$1,
  wrapper: wrapper$4,
  thxWrapper: thxWrapper$1,
  displayFlex: displayFlex$1,
  h1: h1$4,
  h2: h2$1,
  h3: h3$1,
...
const active$1 = "_active_4wt6b_38";
